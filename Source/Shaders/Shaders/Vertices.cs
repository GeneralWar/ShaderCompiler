...
namespace General.Shaders
{
    ...
    public class OutputVertex
    {
        ...
        [OutputVertex(OutputField.Position)] public Vector4 position { get; set; } // no vec3 in block in glsl, instead of vec4
        [OutputVertex(OutputField.Color)] public Vector4 color { get; set; }
        [OutputVertex(OutputField.Normal)] public Vector4 normal { get; set; } // no vec3 in block in glsl, instead of vec4
